  ...
  return (
    <ViewShell error={error} onCloseError={() => setError('')}>
      <SectionHeader
        ...
        subtitle="Interactive portfolio intelligence and strategic financial copilot."
      ...
      <Alert color="amber" variant="light" radius="md" mb="md" icon={<IconInfoCircle size={18} />}>
        <Text size="xs">
          <strong>⚠️ Financial Advice Disclaimer:</strong> Recommendations and analysis generated by Portfolio Copilot are for informational and educational purposes only and do NOT constitute formal financial, investment, legal, or tax advice. All suggestions are to be taken with a grain of salt. Always independently verify recommendations and consult a certified financial professional.
        </Text>
      </Alert>

      {!userProfile.user_description.trim() && (
        <Paper withBorder p="sm" radius="md" bg="var(--mantine-color-default-border)">
          <Group justify="space-between" align="center">
            <Text size="xs" c="dimmed">
              Your investor profile (objectives, risk exposure/tolerance, age, sex/gender, time horizon) is currently empty. Completing it helps Portfolio Copilot provide far more personalized and accurate advice.
            </Text>
              ...
              >
                <Group justify="space-between" mb="xs">
                  <Text size="xs" fw={700} c={msg.role === 'user' ? 'teal.7' : 'dimmed'}>
                    {msg.role === 'user' ? 'You' : 'Portfolio Copilot'}
                  </Text>
                  <Text size="xs" c="dimmed">
                    {msg.timestamp}
                  </Text>
...
function AISettingsModal({
  ...
  return (
    <Modal opened={opened} onClose={onClose} title="Portfolio Copilot & Model Settings" size="lg">
      <Stack gap="md">
