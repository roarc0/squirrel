...
const (
	...
	ProfileServiceName = "v1.ProfileService"
)
...
const (
	...
	// RPC.
	ProfileServiceGetProfileProcedure = "/v1.ProfileService/GetProfile"
	// ProfileServiceUpdateProfileProcedure is the fully-qualified name of the ProfileService's
	// UpdateProfile RPC.
	ProfileServiceUpdateProfileProcedure = "/v1.ProfileService/UpdateProfile"
)

// ProfileServiceClient is a client for the v1.ProfileService service.
...
// NewProfileServiceClient constructs a client for the v1.ProfileService service. By default, it
...
func NewProfileServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProfileServiceClient {
	...
	profileServiceMethods := v1.File_v1_profile_proto.Services().ByName("ProfileService").Methods()
...
// GetProfile calls v1.ProfileService.GetProfile.
...
// UpdateProfile calls v1.ProfileService.UpdateProfile.
...
// ProfileServiceHandler is an implementation of the v1.ProfileService service.
...
func NewProfileServiceHandler(svc ProfileServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/v1.ProfileService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProfileServiceHandler) GetProfile(context.Context, *connect.Request[v1.GetProfileRequest]) (*connect.Response[v1.GetProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.ProfileService.GetProfile is not implemented"))
}
...
func (UnimplementedProfileServiceHandler) UpdateProfile(context.Context, *connect.Request[v1.UpdateProfileRequest]) (*connect.Response[v1.UpdateProfileResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.ProfileService.UpdateProfile is not implemented"))
}
