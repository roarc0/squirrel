...
const (
	...
	AccountServiceName = "v1.AccountService"
)
...
const (
	...
	// ListAccounts RPC.
	AccountServiceListAccountsProcedure = "/v1.AccountService/ListAccounts"
	// AccountServiceCreateAccountProcedure is the fully-qualified name of the AccountService's
	// CreateAccount RPC.
	AccountServiceCreateAccountProcedure = "/v1.AccountService/CreateAccount"
	// AccountServiceUpdateAccountProcedure is the fully-qualified name of the AccountService's
	// UpdateAccount RPC.
	AccountServiceUpdateAccountProcedure = "/v1.AccountService/UpdateAccount"
	// AccountServiceDeleteAccountProcedure is the fully-qualified name of the AccountService's
	// DeleteAccount RPC.
	AccountServiceDeleteAccountProcedure = "/v1.AccountService/DeleteAccount"
)
...
// NewAccountServiceClient constructs a client for the v1.AccountService service. By default, it
...
// ListAccounts calls v1.AccountService.ListAccounts.
...
// CreateAccount calls v1.AccountService.CreateAccount.
...
// UpdateAccount calls v1.AccountService.UpdateAccount.
...
// DeleteAccount calls v1.AccountService.DeleteAccount.
...
func NewAccountServiceHandler(svc AccountServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/v1.AccountService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAccountServiceHandler) ListAccounts(context.Context, *connect.Request[v1.ListAccountsRequest]) (*connect.Response[v1.ListAccountsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.AccountService.ListAccounts is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) CreateAccount(context.Context, *connect.Request[v1.CreateAccountRequest]) (*connect.Response[v1.CreateAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.AccountService.CreateAccount is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) UpdateAccount(context.Context, *connect.Request[v1.UpdateAccountRequest]) (*connect.Response[v1.UpdateAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.AccountService.UpdateAccount is not implemented"))
}
...
func (UnimplementedAccountServiceHandler) DeleteAccount(context.Context, *connect.Request[v1.DeleteAccountRequest]) (*connect.Response[v1.DeleteAccountResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("v1.AccountService.DeleteAccount is not implemented"))
}
